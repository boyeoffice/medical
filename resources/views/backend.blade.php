...
<link rel="stylesheet" href="{{asset('css/select2-bootstrap.min.css')}}"><link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
<title>Dashboard</title><script> window.Laravel = {
            csrfToken: "{{ csrf_token() }}"
        }
        window.User = {!! Auth::user() !!}
        window.url = "{{url('/')}}"
    </script></head><body class="skin-blue sidebar-mini"><div id="app"></div><script src="{{mix('js/vendor.js')}}"></script><script src="{{mix('js/cms.js')}}"></script>
</body>
</html>
