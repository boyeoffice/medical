		...
		<section class="sidebar" style="height: auto;">
			...
			<ul class="sidebar-menu" data-widget="tree">
				...
				<li class="treeview" v-if="authUser.is_admin == 1">
					...
					<ul class="treeview-menu">
						<router-link to="/suggestions/icd10_group" tag="li">
							<a>
								<i class="fa fa-circle-o"></i>
								Grupos ICD 10
							</a>
						</router-link>
						<router-link to="/suggestions/icd10_single" tag="li">
							<a>
								<i class="fa fa-circle-o"></i>
								ICD 10
							</a>
						</router-link>
						<router-link to="/suggestions/origin_destination" tag="li">
							<a>
								<i class="fa fa-circle-o"></i>
								Origem/Destino
							</a>
						</router-link>
						<router-link to="/suggestions/query_techniques" tag="li">
							<a>
								<i class="fa fa-circle-o"></i>
								Técnicas
							</a>
						</router-link>
						<router-link to="/suggestions/specialty" tag="li">
							<a>
								<i class="fa fa-circle-o"></i>
								Especialidade
							</a>
				...
				<router-link to="/atividade-cientifica" tag="li">
				<a>
					<i class="fa fa-user"></i>
					<span>Atividade Cientifica</span>
				</a>
				</router-link>
				<router-link to="/formacao" tag="li">
				<a>
					<i class="fa fa-user"></i>
					<span>Formacao</span>
				</a>
				</router-link>
				<router-link to="/agenda" tag="li">
				<a><i class="fa fa-calendar"></i>
				<span>Agenda</span></a>
				</router-link>
				<router-link v-if="authUser.is_admin == 1" to="/settings" tag="li">
