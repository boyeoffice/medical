				...
				<data-viewer :filter="filter" :source="source" :create="create" :title="title" :thead="thead" :BoxClass="BoxClass">
					<template slot-scope="props">
						<tr>
							...
							<td>
								<router-link :to="'/consults/' + props.item.id + '/edit'" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></router-link>
							</td>
						</tr>
					</template>
				</data-viewer>
...
<script>
import DataViewer from '_/vendor/BoxTableRes.vue'
	export default{
