            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Fomacao</h3>
                        <div class="box-tools pull-right">
                            <router-link class="btn btn-sm btn-success" to="/formacao/create">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr v-for="data in model.data">
                                    <td>{{ data.tipo }}</td>
                                    <td>{{ data.nome }}</td>
                                    <td>{{ data.entidade_organizadora }}</td>
                                    <td>{{ data.local }}</td>
                                    <td>{{ data.data }}</td>
                                    <td>{{ data.nacional }}</td>
                                    <td>{{ data.nota }}</td>
                                    ...
                                    <td>
                                        <router-link class="btn btn-sm btn-primary" :to="'/formacao/' + data.id + '/edit'">
